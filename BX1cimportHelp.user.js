...
addGlobalStyle('.bx1cimport {position: absolute;background-color: #f1f1f1;border: 1px solid #d3d3d3;/*text-align: center;*/margin: 0 auto;width:1000px;height:800px;top: 5%;left: 20%;display:none;padding: 5px;border-color: black;border-style: solid;z-index:999999999;background-color: white;}');
    ...
    // скачасть xml файл
        ...
        function bxFormImport1c() {
            if(document.getElementsByClassName('bx1cimport')[0].style.display !== 'block'){
                ...
                document.getElementById('bx-admin-prefix').style.overflow = 'hidden';
