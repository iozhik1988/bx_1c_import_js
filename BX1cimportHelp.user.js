...
addGlobalStyle('#divheader {padding: 10px;cursor: move;z-index: 10;background-color: #2196F3;color: #fff;display: inline-block;width: 932px;height: 18px;}');
addGlobalStyle('.btn {background-color: #2196F3;border: none;color: white;padding: 12px 16px;font-size: 14px;cursor: pointer;}');
addGlobalStyle('.btn:hover {background-color: RoyalBlue;}');
...
$(document).ready(function() {
    ...
    $('.bx1cimport').append('<div id="divheader">Скрипт импорта xml 1C</div>');
    $('.bx1cimport').append('<button class="btn" id="closeform"><i class="fa fa-close"></i></button>');
